...
| Durable lesson that applies across projects or sessions | `memory/*.md` (per top-level AGENTS.md memory instructions) | not this skill — write a memory |
